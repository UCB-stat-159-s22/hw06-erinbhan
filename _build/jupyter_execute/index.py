...
# import the ligotools detector plotting function
...
for det in dets:
    ...
    if make_plots:
        ...
        plot_detector_changes(time, timemax, SNR, pcolor, det, eventname, plottype, tevent, strain_whitenbp,
